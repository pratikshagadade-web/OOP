...
int main() {
    float studentMarks[5] = {8.6, 8.0, 8.4, 7.5, 9.0};
    
    Student s1("pratiksha gadade", 21, 30, "CSE(AI-ML)", studentMarks);
    Faculty f1("anjali", 35, 107, "Computer Science(Artificial Intelligence & Machine Learning)", 70000);
    TeachingAssistant ta1("ankita", 38, 212, "AI-ML", studentMarks, 1002, "AI-ML", 30000);
